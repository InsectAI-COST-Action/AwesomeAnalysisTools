...
| Tool Name | Tags | Description | Programming language | Available | Open Source? | Links |
|:----------|:-----|:------------|:---------------------|:----------|:-------------|:------|
| β-Variational Autoencoders | CV | Approach for reverse taxonomy and the detection and characterization of cryptic diversity. | Python | Not yet (in development) | - | - |
...
| Tool Name | Tags | Description | Programming language | Available | Open Source? | Links |
|:----------|:-----|:------------|:---------------------|:----------|:-------------|:------|
| DAISY | CV | Digital Automated Identification SYstem. Daisy is a universal identification AI. It can be applied to anything: images, sounds, chemical spectra, even molecular data. | N/A | No longer available | - | - |
