...
| InsectDCT | CV, Monitoring | Generalised pipeline for detection, hierarchical taxonomic classification (80 groups across order/family/genus/species) and spatiotemporal tracking of insects in camera-trap images and video. Built on YOLO11; pre-trained classifier models and annotated training/test datasets are published on Zenodo. Runs on desktop (CUDA or CPU) and Raspberry Pi. | Python | Yes | Open Source | [github](https://github.com/kimbjerge/insectDCT) [paper](https://www.biorxiv.org/content/10.64898/2026.07.07.736939v2) |
...
| Automated monitoring of insects system: building a non-lethal and scalable solution for monitoring of nocturnal insects | Research article | Lord, Teagle, Alton et al. | Describes the open-source UKCEH AMI system — a single-board-computer insect camera trap with UV/LED attractant lights for autonomous, non-lethal monitoring of nocturnal insects. Covers the full hardware build, deployment and data pipeline; 194 units deployed across 32+ countries. | Yes — software on [GitHub](https://github.com/AMI-system); design files, BOM and engineering drawings on [Zenodo](https://zenodo.org/records/18131879) | [paper](https://doi.org/10.1016/j.ohx.2026.e00822), [preprint](https://www.biorxiv.org/content/10.64898/2026.02.06.704388v1) |
